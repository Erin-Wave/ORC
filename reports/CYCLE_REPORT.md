...
- run `ff0596984af4` finished 2026-09-05T05:41:33.848820+00:00
- trials in project: **7230** (+108 this cycle)
...
|---|---|---:|---:|---|---|
| H0001 | ETHUSDT | +67.9% | n/a | invested | spike, 1.02 paths, PBO unmeasured, p=0.540 vs a random search |
| H0001 | SOLUSDT | +37.3% | 851.7% | invested | spike, 1.16 paths, PBO unmeasured, p=0.790 vs a random search |
| H0001 | BTCUSDT | +36.2% | n/a | invested | spike, 1.07 paths, PBO unmeasured, p=0.455 vs a random search |
| H0001 | BNBUSDT | +8.1% | 274.8% | invested | spike, 1.36 paths, PBO unmeasured, p=0.745 vs a random search |
| H0001 | XRPUSDT | -5.3% | 142.5% | invested | at or below 0, shape unmeasured, 1.4 paths, PBO unmeasured, p=0.465 vs a random search |
| H0001 | DOGEUSDT | -9.9% | 1349.2% | invested | at or below 0, shape unmeasured, 1.23 paths, PBO unmeasured, p=0.755 vs a random search |
| H0001 | LTCUSDT | -23.7% | 130.7% | invested | at or below 0, shape unmeasured, 1.39 paths, PBO unmeasured, p=0.570 vs a random search |
| H0001 | AVAXUSDT | -29.9% | 311.7% | invested | at or below 0, shape unmeasured, 1.16 paths, PBO unmeasured, p=0.835 vs a random search |
| H0001 | ADAUSDT | -32.0% | 424.2% | invested | at or below 0, shape unmeasured, 1.37 paths, PBO unmeasured, p=0.850 vs a random search |
...
| H0019 `cci_mtf_regime_pullback` | [claude] clause: 4. SPIKE. Closed if the recorded shape of the best cell is SPIKE on 5 or more of the 9 symbols. -- Clause 4 is met on 8 of 9 symbols against a threshold of 5. Every symbol except BTCUSDT records shape 'SPIKE' at its best cell -- ADA, AVAX, BNB, DOGE, ETH, LTC, SOL and XRP -- and BTCUSDT's diagnostic is 'unmeasurable' only because its peak calmar is -0.10242194712616623, so it cann... | `reports/POSTMORTEM_H0019.md` |
...
Trials in this family: 1452. Pre-registration hash `16461da7e4b64a49`.

| symbol | best | shape | neighbour/peak | start offsets | indep. paths | best cell |
|---|---:|---|---:|---:|---:|---|
| ETHUSDT | +0.6789 | SPIKE | -1.015 | 616 | 1.02 | `{'include_funding': False, 'n_contributions': 52, 'stride_days': 30.0}` |
| SOLUSDT | +0.3727 | SPIKE | -2.069 | 4,289 | 1.16 | `{'include_funding': False, 'n_contributions': 156, 'stride_days': 7.0}` |
| BTCUSDT | +0.3616 | SPIKE | -1.969 | 2,523 | 1.07 | `{'include_funding': False, 'n_contributions': 52, 'stride_days': 30.0}` |
...
- PBO on **BNBUSDT** could not be computed: fewer than two configurations share a horizon
- PBO on **XRPUSDT** could not be computed: fewer than two configurations share a horizon
- PBO on **DOGEUSDT** could not be computed: fewer than two configurations share a horizon
- PBO on **LTCUSDT** could not be computed: fewer than two configurations share a horizon
- PBO on **AVAXUSDT** could not be computed: fewer than two configurations share a horizon
- PBO on **ADAUSDT** could not be computed: fewer than two configurations share a horizon
